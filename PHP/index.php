...
//Не придумал как обнулить элемент между крайними, разве что создать новый массив который будет хранить повторяющиеся числа и уже потом их обнулять с помощью него.
for($i = 0; $i < count($arr); $i++){
    echo $arr[$i], ' ';
}
